...
namespace ControleFornecedoresEmpresaAPI.Services
{
    public class ValidacoesService
    {
        ...
        public bool ValidaNascimentoMaiorDeIdade(DateTime dataNascimento)
        {
        ...
        public string LimpaCPFCNPJ(string cpfcnpj)
        {
